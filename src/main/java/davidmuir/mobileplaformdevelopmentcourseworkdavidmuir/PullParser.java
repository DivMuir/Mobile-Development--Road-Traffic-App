...
public class PullParser extends AppCompatActivity {
    ...
    List<ReportDisplay> rwList = new ArrayList<>();
    ReportList adapter;
        ...
        dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker picker, int year, int month, int day) {
                ...
                try {
                    ...
                    List<ReportDisplay> newList = new ArrayList<ReportDisplay>();
                    for (ReportDisplay item : rwList) {
                        if (item.startDate.equals(theSearchDate)) {
                            newList.add(item);
                        }
                    }

                    adapter = new ReportList(getApplicationContext(), R.layout.report_list_item, newList);
    ...
    private void StartFullDetail(ReportDisplay item) {
    ...
    class RSSFetch extends AsyncTask<Void, Void, List<ReportDisplay>> {
        ...
        protected void onPreExecute() {
            theDialog = new ProgressDialog(PullParser.this);
